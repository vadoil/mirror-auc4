      ...
      <div className="pt-28 pb-20">
        ...
        <div className="section-padding mb-16">
          <div className="max-w-7xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              <h1 className="font-display text-5xl md:text-7xl lg:text-8xl text-foreground uppercase tracking-tight leading-[0.9] mb-4">
        ...
        <div className="section-padding">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="bg-muted/50 border border-border rounded-lg p-8">
              <MapPin className="w-6 h-6 text-primary mb-4" />
              <h3 className="font-display text-xl text-foreground uppercase mb-2">Адрес</h3>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="bg-muted/50 border border-border rounded-lg p-8">
              <Train className="w-6 h-6 text-primary mb-4" />
              <h3 className="font-display text-xl text-foreground uppercase mb-2">Как добраться</h3>
              <p className="font-body text-sm text-muted-foreground leading-relaxed">
                5 минут пешком от м. Чистые пруды / Тургеневская / Сретенский бульвар
              </p>
            </motion.div>

            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="bg-muted/50 border border-border rounded-lg p-8">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9 }} className="bg-muted/50 border border-border rounded-lg p-8">
