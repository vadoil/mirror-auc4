...
const steps = [
  ...
  { icon: Heart, title: "Сделайте добро", desc: "Все деньги, вырученные с продаж билетов и аукциона, будут направлены в поддержку фонда «Не напрасно»." },
];
...
const faqs = [
  ...
  { q: "Куда направляются средства?", a: "Все деньги, вырученные с продаж билетов и аукциона, будут направлены в поддержку фонда «Не напрасно». Полный отчёт публикуется после мероприятия." },
