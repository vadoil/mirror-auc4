...
const speakersData = [
  ...
  },
  {
    ...
    bio: "Операционный директор проектов Алексея Ситникова",
    highlights: [
  ...
  },
  {
    ...
    bio: "Предприниматель в области здоровья и превенции, сооснователь сервиса превентивной медицины Hedonist, биохакер, экс-совладелец клиники LAB Rehab, эксперт в маркетинге в сфере здоровья и красоты.",
    highlights: [
      "Сооснователь сервиса превентивной медицины Hedonist",
      "Экс-совладелец клиники LAB Rehab",
      "Опыт работы с Bentley, Mercedes-Benz, Vertu, GQ, Condé Nast Traveller, Elemis, Biogena, Tous, The Ritz-Carlton, Lotte и др.",
    ],
    image: evnichPhoto,
