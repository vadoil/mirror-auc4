...
const programItems = [
  ...
  },
  {
    ...
    body: "Специально для этого вечера три совершенно разных художника создали работы, объединённые общей темой. Акция «Искусство смыслов» пройдёт в очном и онлайн-форматах, следите за ней прямо со смартфона через QR-код. Каждый уйдет с события с картиной.",
  },
  {
    icon: Eye,
