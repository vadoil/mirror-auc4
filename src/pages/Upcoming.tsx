...
const artists = [
  {
    ...
    text: "Российский художник-концептуалист, мастер жизнерадостного поп-арта, предприниматель и общественный деятель, основатель «Центра поддержки искусств Санкт-Петербурга». Представил холсты из своей знаковой серии.",
    photo: artist1,
  },
  {
    name: "Андрей Бартенев",
    role: "художник, сценограф, перформер",
    text: "Один из главных представителей российского перформанса и сюрреализма, педагог, ведущий популярного шоу «Модный приговор». Передал в благотворительную продажу свои объекты-инсталляции.",
    photo: artist2,
  },
  {
...
const programItems = [
  {
    ...
    body: (
      <>
        ...
        Владислав объяснил разницу между грамотным скринингом по международным протоколам и коммерческими предложениями «сдай всё подряд» и рассказал, какие популярные инструменты заботы о здоровье полезны, а какие вредят. После лекции гости задавали вопросы.
      </>
    ),
  },
  {
    ...
    body: "Специально для этого вечера три совершенно разных художника создали работы, объединённые общей темой. Акция «Искусство смыслов» прошла в очном и онлайн-форматах, за ней следили прямо со смартфона через QR-код. Каждый гость ушёл с картиной.",
  },
  {
    icon: Eye,
    ...
    body: "Современное оборудование позволило за 15 минут бесконтактно измерить внутриглазное давление, проверить остроту зрения и сделать снимок сетчатки.",
  },
  {
    icon: Utensils,
    ...
    body: "Вечер завершили лёгкие гастрономические сеты и неспешное общение с гостями, художниками и командой фонда.",
  },
];
              ...
              <div className="lg:col-span-6 flex flex-col">
                ...
                <div className="space-y-6 font-body text-base md:text-lg text-muted-foreground leading-relaxed max-w-xl flex-1">
                  ...
                  <p>
                    ...
                    офтальмологии <span className="text-foreground font-medium italic">«Зрение»</span> открыл
                    свои двери для особенного вечера. Мы собрались там, где каждый день дарят людям
                    возможность чётко видеть мир, чтобы вместе сфокусироваться на главном — на
                    будущем без страха перед раком.
                  </p>
                  <p className="text-foreground">
                    Вечер состоялся <span className="text-primary font-medium">13 августа 2026 года</span>.
                    Собранные средства направлены на программы помощи людям с
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              ...
              <h2 className="font-display text-3xl md:text-5xl uppercase tracking-tight text-foreground leading-[0.95]">
                Как прошёл <span className="italic text-primary">вечер</span>
              </h2>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              ...
              <p className="font-body text-sm md:text-base text-muted-foreground mt-4 max-w-2xl">
                ...
                общей темой. Собранные средства направлены в фонд «Не напрасно».
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-0 border border-border rounded-lg overflow-hidden mb-6">
              ...
              <div className="p-8 md:p-10 bg-muted/30 flex flex-col justify-center">
                ...
                <p className="font-body text-sm text-muted-foreground/80 leading-relaxed">
                  <span className="text-foreground font-medium">Дата:</span> 13 августа 2026.
                  Вечер состоялся, сбор гостей был в <span className="text-foreground font-medium">17:30</span>.
                </p>
              </div>
            </div>
