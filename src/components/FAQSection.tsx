...
const faqs = [
  ...
  },
  {
    ...
    a: "Все деньги, вырученные с продаж билетов и аукциона, будут направлены в поддержку фонда «Не напрасно». Полный отчёт публикуется после мероприятия.",
  },
  {
  ...
  },
  {
    ...
    a: "После оплаты мы свяжемся с вами для передачи лота.",
  },
  {
