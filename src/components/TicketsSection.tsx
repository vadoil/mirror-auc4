...
const ticket = {
  ...
  features: [
    ...
    "Взнос вычитается из стоимости выигранного лота",
    "Вся сумма билета уходит в поддержку фонда «Не напрасно»",
  ],
  icon: Gavel,
};
        ...
        <div ref={ref} className="max-w-5xl mx-auto relative z-10">
          ...
          >
            <p className="font-body text-[11px] text-cream/30 max-w-2xl mx-auto leading-relaxed">
              После отправки заявки наш менеджер свяжется с вами для подтверждения регистрации и оплаты. Взнос является невозвратным. При покупке лота сумма регистрационного взноса (15 000 ₽) вычитается из стоимости лота. Есть промокод? Введите его при регистрации.
            </p>
          </motion.div>
        </div>
      </section>
