            ...
            {activeCity === "moscow" && (
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="font-body text-xs text-primary uppercase tracking-[0.2em]">Wellness · Долголетие · Нейрогастрономия</p>
                </div>

                <p className="font-body text-sm md:text-base text-foreground leading-relaxed mb-4">
                  В столице мы сфокусируемся на wellness-повестке, поговорим о долголетии и нейрогастрономии, продегустируем Blends от Inspiro – б/а напитки, продлевающие молодость мозга, проведём вечер в компании искромётного Александра Цыпкина и сможем сделать вклад в спасение от онкозаболеваний.
                </p>
                ...
                <p className="font-body text-sm md:text-base text-muted-foreground leading-relaxed mb-6">
                  «Отражение добра» – это аукцион, где каждый лот несёт смысл. Уникальные wellness-программы, ретриты, эксклюзивный опыт, а все деньги, вырученные с продаж билетов и аукциона, направляются в поддержку фонда «Не напрасно».
                </p>
