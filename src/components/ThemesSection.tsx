...
const themes = [
  {
    ...
    desc: "Нейрофидбек, стимуляция мозга, программы когнитивного развития от ведущих клиник мира.",
    accent: true,
  },
  {
    icon: Dna,
    num: "02",
    title: "Биохакинг и долголетие",
    desc: "Генетические тесты, программы омоложения, персональные протоколы долголетия.",
    accent: false,
  },
  {
    icon: Leaf,
    num: "03",
    title: "Ретриты и очищение",
    desc: "Авторские ретриты на Бали, в Швейцарии, Индии. Цифровое и физическое очищение.",
    accent: false,
  },
  {
    icon: Zap,
    num: "04",
    title: "Криотерапия и восстановление",
    desc: "Криокамеры, гипербарическая оксигенация, инфракрасные сауны, капельная терапия.",
    accent: false,
  },
  {
    icon: Heart,
    num: "05",
    title: "Осознанность и практики",
    desc: "Индивидуальные сессии с мастерами медитации, холотропное дыхание, звуковые медитации.",
    accent: false,
  },
];
