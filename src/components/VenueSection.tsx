          ...
          >
            ...
            <div className="p-8 md:p-12 flex flex-col justify-center flex-1 -mt-20 relative z-10">
              ...
              <p className="font-body text-sm text-cream/60 leading-relaxed mb-8 max-w-md">
                Пространство нового формата в центре Москвы, где соединяются культура заботы о здоровье, осознанность и эстетика. Место, где можно замедлиться, вдохнуть глубже и почувствовать баланс – идеальная атмосфера для вечера «Отражение».
              </p>
