        ...
        <div className="section-padding flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-4 xl:gap-8">
            ...
            {isHome && (
              <a
                href="#about"
                className={`${textColor} text-[10px] xl:text-[11px] uppercase tracking-[0.15em] xl:tracking-[0.2em] font-body font-light ${textHover} transition-colors duration-300`}
              >
                О проекте
              </a>
            )}
            ...
            <button
              ...
              className="ml-4 bg-primary text-primary-foreground text-[10px] xl:text-[11px] uppercase tracking-[0.15em] xl:tracking-[0.2em] px-6 py-2.5 hover:opacity-90 transition-all duration-500 font-body"
            >
              Задать вопрос
            </button>
            {user ? (
              <button
                onClick={() => signOut()}
                className={`${secondaryText} text-[10px] xl:text-[11px] uppercase tracking-[0.15em] xl:tracking-[0.2em] font-body font-light ${secondaryHover} transition-colors duration-300`}
              >
                Выйти
              </button>
            ) : (
              <Link
                to="/auth"
                className={`flex items-center gap-1.5 ${secondaryText} text-[10px] xl:text-[11px] uppercase tracking-[0.15em] xl:tracking-[0.2em] font-body font-light ${secondaryHover} transition-colors duration-300`}
              >
