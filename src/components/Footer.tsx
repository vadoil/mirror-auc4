        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            <h3 className="font-display text-3xl md:text-4xl font-light text-cream mb-2">
              Увидимся <span className="italic text-primary">Увидимся <span className="italic text-primary">26 апреля</span></span>
            </h3>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            <div>
              ...
              <p className="font-body text-xs text-cream/30 leading-relaxed">
                Благотворительный аукцион. Все средства направляются на помощь тем, кто в ней нуждается.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <p className="font-body text-xs text-cream/30">Александра</p>
                <p className="font-body text-xs text-cream/30">8 (962) 364-66-46</p>
                <p className="font-body text-xs text-cream/30">@alexa_auction</p>
              </div>
            </div>
            <div>
