...
const formats = [
  ...
  { icon: Sparkles, title: "Зона заботы о здоровье", desc: "Криокамера, массаж, нейрофидбек на месте" },
  { icon: GlassWater, title: "Бар очищения", desc: "Суперфуд-коктейли, адаптогены, комбуча" },
  { icon: Users, title: "Нетворкинг", desc: "Знакомства с лидерами индустрии здоровья" },
];
